...
save_button = Button(screen_width // 2 - 120, screen_height - 64, save_img)
load_button = Button(screen_width // 2 + 40, screen_height - 64, load_img)
...
while run:
	...
	draw_text(f'Level: {level}', font, white, tile_size, screen_height - 48)
	draw_text('Press UP or DOWN to change level', font, white, tile_size, screen_height - 32)
